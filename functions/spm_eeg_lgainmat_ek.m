...
% Karl Friston
% $Id: spm_eeg_lgainmat.m 4734 2012-05-08 21:48:06Z vladimir $
...
try
    ...
    for ind = 1:numel(forward)
        ...
        % Forward computation
        %------------------------------------------------------------------
        [vol, sens] = ft_prepare_vol_sens_ek(vol, sens, 'channel', forward(ind).channels);
        nvert = size(vert, 1);
